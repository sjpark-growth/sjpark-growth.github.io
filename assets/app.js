...
(function () {
  ...
  function renderShowcase() {
    ...
    side.innerHTML = `
      ...
      <div class="actions"><button class="btn" type="button" data-big>${ICON.expand}크게 보기 · 직접 조작</button><a class="btn ghost" href="${p.demo}" target="_blank" rel="noopener">${ICON.ext}새 창</a></div>
